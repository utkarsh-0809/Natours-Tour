    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 8:
          ...
          (0, _alert.showAlert)('error', "".concat(_context.t0.message));
...
function createMap(locations) {
  ...
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/utkarsh0908/cly6u6bjp00du01pmbc94aber',
    // style URL
    center: [-118.2541722, 34.043881],
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p> ".concat(loc.day, " Day ").concat(loc.description, "</p>")).addTo(map);
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 10:
          ...
          (0, _alert.showAlert)('error', (_err$response = _context.t0.response) === null || _err$response === void 0 ? void 0 : _err$response.data);
        case 13:
        case "end":
          return _context.stop();
      }
...
exports.updateUser = exports.updatePassword = exports.updateImage = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alert = require("./alert");
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          (0, _alert.showAlert)('success', 'updted succuessfully');
          _context.next = 11;
          break;
        case 8:
          _context.prev = 8;
...
var updatePassword = exports.updatePassword = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(currPassword, newPassword, newConfirm) {
    var res;
...
var updateImage = exports.updateImage = /*#__PURE__*/function () {
  ...
  return function updateImage(_x5) {
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var stripe = Stripe('pk_test_51PZoc3JXB0z12BP0HmDKKFINyaQIT8wlOXCnp4fg3pUcQKIbilVL5oR5kvSO8nweuq8lx34D4zbbJwpvOLPBn22I00eietco9o');
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 7:
          (0, _alert.showAlert)('success', 'Your payment was successful');
          _context.next = 13;
          break;
        case 10:
          _context.prev = 10;
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
function signUpUser(_x, _x2, _x3, _x4) {
  return _signUpUser.apply(this, arguments);
}
function _signUpUser() {
  _signUpUser = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(email, name, password, passwordConfirm) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var locations = (_document$querySelect = document.querySelector('#map')) === null || _document$querySelect === void 0 ? void 0 : _document$querySelect.getAttribute('data-location');
if (locations) {
  locations = JSON.parse(locations);
  (0, _mapBox.createMap)(locations);
}
(_document$querySelect2 = document.querySelector('.form-login')) === null || _document$querySelect2 === void 0 || _document$querySelect2.addEventListener('submit', function (e) {
  e.preventDefault();
...
(_document$querySelect3 = document.querySelector('.nav__el--logout')) === null || _document$querySelect3 === void 0 || _document$querySelect3.addEventListener('click', function (e) {
  e.preventDefault();
  (0, _logout.logout)();
});
(_document$querySelect4 = document.querySelector('.btn--updateMe')) === null || _document$querySelect4 === void 0 || _document$querySelect4.addEventListener('click', function (e) {
  e.preventDefault();
...
(_document$querySelect5 = document.querySelector('.savePassword')) === null || _document$querySelect5 === void 0 || _document$querySelect5.addEventListener('click', function (e) {
  e.preventDefault();
  var currPassword = document.querySelector('#password-current').value;
  var newPassword = document.querySelector('#password').value;
  var newConfirm = document.querySelector('#password-confirm').value;
  (0, _updateUser.updatePassword)(currPassword, newPassword, newConfirm).then(function () {
    document.querySelector('#password-current').value = '';
    document.querySelector('#password').value = '';
    document.querySelector('#password-confirm').value = '';
  }).catch(function (err) {
    return (0, _alert.showAlert)('error', err.message);
  });
});
var btnBookings = document.querySelector('#bookTour');
btnBookings === null || btnBookings === void 0 || btnBookings.addEventListener('click', function (e) {
  e.preventDefault();
  e.target.textContent = 'processing...';
  var tourId = e.target.getAttribute('data-tourId'); // tour-id from pug will be converted to tourId in js

  (0, _stripe.bookTour)(tourId);
});
var signup = document.querySelector('.Signup');
signup === null || signup === void 0 || signup.addEventListener('click', function (e) {
  window.location.href = '/signup';
});
var singupForm = document.querySelector('.Signup-form');
singupForm === null || singupForm === void 0 ? void 0 : singupForm.addEventListener('submit', /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          confirmPassword = document.querySelector('.Confirmpassword_Signup').value;
          (0, _signup.signUpUser)(email, name, password, confirmPassword);
        case 6:
        case "end":
          return _context.stop();
      }
